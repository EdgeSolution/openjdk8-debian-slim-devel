...
services:
     androidlink: 
        image: 172.21.73.113/androiddm-aliyun/androiddm-javaenv-slim-aliyun:v1.0.0
        restart: always
        depends_on:
                - mqtt
                - db
        ...
        environment: 
                - TZ=Asia/Shanghai
     mqtt:
        image: 172.21.73.113/androiddm-aliyun/androiddm-mosquitto-aliyun:v1.0
        restart: always
        ports: 
                - "1883:1883"
                - "11880:11880"
     ...
     db:
        ...
        networks: 
              - advnet
     astore:
        image: 172.21.73.113/androiddm-aliyun/androiddm-astore-slim-aliyun:v1.0.0
        restart: always
        depends_on:
                - db
        volumes:
        ...
        environment: 
                - TZ=Asia/Shanghai
     novnc:
        image: 172.21.73.113/androiddm-aliyun/androiddm-novnc-aliyun:v1.0
        restart: always
        volumes:
                - ./java-env/vnctoken/:/root/adv/vnctoken/
